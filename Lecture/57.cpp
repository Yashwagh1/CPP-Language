...
2. they are accessd by object pointer 
3. virtual function can be a friend of another class
4. a function in base class can might not be use
5.if a virtual function define in base class, there is no necessity of redefine it in the 
derivied class
*/
